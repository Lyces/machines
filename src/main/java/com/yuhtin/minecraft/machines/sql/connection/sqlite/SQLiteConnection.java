package com.yuhtin.minecraft.machines.sql.connection.sqlite;

import com.yuhtin.minecraft.steelbosses.Bosses;
    ...
    public Connection findConnection() {
        if (connection == null) {
            ...
            try {
                ...
                Bukkit.getPluginManager().disablePlugin(Bosses.getInstance());
